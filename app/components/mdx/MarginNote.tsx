...
export function MarginNote({ title = "На заметку", children }: { title?: string, children: ReactNode }) {
  return (
    <aside className="not-in-toc my-6 p-5 text-sm border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/10 dark:border-blue-400 rounded-r-xl shadow-sm w-full md:w-3/4 lg:w-2/3 ml-auto">
