...
export function MarginNote({ title = "На заметку", children }: { title?: string, children: ReactNode }) {
  return (
    <aside className="not-in-toc float-none lg:float-right lg:w-72 lg:ml-8 lg:-mr-4 xl:-mr-12 mb-6 mt-2 p-5 text-sm border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/10 dark:border-blue-400 rounded-r-xl shadow-sm clear-right">
