...
function CollapsibleSection({ section, pathname }: { section: NavItem; pathname: string }) {
  ...
  return (
    <div>
      ...
      >
        <div className="flex items-center transition-transform duration-200 group-hover:translate-x-1 flex-1 min-w-0 pr-2">
              ...
              <li key={j} className="relative">
                ...
                >
                  <span className="flex items-center transition-transform duration-200 group-hover:translate-x-1 w-full">
                    ...
                    <span className="flex-1 min-w-0 leading-tight">{item.title}</span>
                  </span>
                </Link>
              </li>
            )
