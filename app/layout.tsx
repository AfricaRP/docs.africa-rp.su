      ...
      <body className={`${minecraftFont.className} bg-zinc-50 dark:bg-zinc-950 text-zinc-800 dark:text-zinc-100`}>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          <div className="flex min-h-screen">
            {/* Sidebar Left */}
            <aside className="w-56 border-r border-zinc-200 dark:border-zinc-800 p-4 shrink-0 overflow-y-auto sticky top-0 h-screen flex flex-col">
            ...
            <div className="flex-1 flex justify-between">
              {/* Content Center */}
              <main className="flex-1 px-8 lg:px-16 py-8 overflow-y-auto prose prose-zinc dark:prose-invert max-w-4xl min-w-0 mx-auto">
                {children}
              </main>
