...
**Как писать:**
```mdx
Добавьте щепотку <HoverCard title="Мускатный орех" description="Пряность с теплым и сладковатым ароматом, которая идеально дополняет выпечку." image="https://images.unsplash.com/photo-1596647953287-25e24a5eb2ec?q=80&w=400">мускатного ореха</HoverCard> для аромата.
```
